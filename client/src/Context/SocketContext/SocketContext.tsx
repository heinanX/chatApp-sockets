...
// LeavLobbyfunktionen som körs från commponenten LeaveLobbyBtn
    ...
    return (
        <SocketContext.Provider value={{ username, setUsername, currentRoom, setCurrentRoom, isLoggedIn, setIsLoggedIn, logIn, joinRoom, roomsList, setRoomsList, leaveLobby }}>
            {children}
